...
import GraphOwlsLogo from '@src/assets/images/logo.svg';
import { Link } from 'react-router-dom';

const links = [
  { title: 'Documentation', href: 'https://graphowls.com', description: 'Learn about GraphOwls', icon: BookOpenIcon },
  { title: 'Architecture guide', href: 'https://graphowls.com/docs/architecture-guide', description: 'Overview of the GraphOwls architecture', icon: BookmarkSquareIcon },
];

const social = [
  {
    name: 'GitHub',
    href: 'https://github.com/jerlendds/graphowls',
    icon: (props: any) => (
    ...
    <div className='bg-dark-400'>
      <main className='mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='flex-shrink-0 pt-16'>
          <img className='mx-auto h-12 w-auto' src={GraphOwlsLogo} alt='GraphOwls' />
        </div>
      ...
      <footer className='mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='border-t border-dark-100 py-12 text-center md:flex md:justify-between'>
          <p className='text-base text-slate-400'>&copy; GraphOwls. All rights reserved.</p>
