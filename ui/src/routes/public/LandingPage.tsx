            ...
            <div className='relative px- sm:px-3 z-10 md:text-center lg:text-left'>
              <div className='relative pb-12'>
                ...
                <p className='pt-1 text-lg tracking-tight  text-slate-400'>
                  Reveal the connections that shape our world and stay informed with targeted insights from public data. From defending against cyber threats and corruption to finding reproducible research and beyond, visualize the invisible with GraphOwls.
                </p>
          ...
          <div className='mx-auto grid  max-w-2xl grid-cols-1 mt-auto mb-0 items-center lg:max-w-8xl flex-grow'>
            <div className='relative z-10 md:text-center lg:text-left '>
              <header className='space-y-1 mt-24 md:mt-0'>
                <p className='font-display text-sm font-medium tracker-tighter text-primary-200'>Welcome to GraphOwls</p>
                <h1 className='font-display text-3xl tracking-tight text-slate-300 dark:text-slate-300'>
                  {atfQuote}
                </h1>
              </header>

              <div className='docs max-w-4xl text-slate-400 py-2'>Please email <a href='mailto:oss@graphowls.com' className='text-primary-200 hover:text-primary-200/80 transition-colors duration-100 font-sans ease-in-out'>oss@GraphOwls.com</a> to share ideas, bugs, or security concerns
              </div>.
            </div>
          </div>
