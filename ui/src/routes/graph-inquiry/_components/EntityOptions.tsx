          ...
          <div className='flex flex-col w-full select-none'>
            ...
            <div className='flex flex-wrap items-center gap-x-2 text-xs leading-5 text-slate-500'>
              ...
              <p className='truncate flex items-center leading-5 text-slate-500 text-xs'>
                ...
                Created by {entity.author ? entity.author : 'the GraphOwls team'}
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        <section>
          <p className='py-4 px-2 text-slate-500 text-xs'>More layouts, options, and controls for managing entity layouts will be here one day. Get the latest updates on the <a className='text-primary-300' href="https://forum.graphowls.com/">forum</a> or <a className='text-primary-300' href="https://discord.gg/gsbbYHA3K3">discord</a></p>
        </section>
      </div>
    </ResponsiveGridLayout>
  );
