    ...
    <>
      ...
      <div className="flex flex-col sm:px-2 lg:px-6 my-2 relative mx-auto w-full justify-center">
        <p className="text-slate-300/95">
          Take control of the GraphOwls app theme, your account information,<br /> and permissions for any shared workspaces or graphs.
        </p>
      </div>
          ...
          <div className="flex justify-between">
            {/* <div className="flex flex-col">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-400">
                Connect proxies to GraphOwls one by one or by uploading a txt
