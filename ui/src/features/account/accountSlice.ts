...
export const account = createSlice({
  ...
  reducers: {
      ...
      state.activeTour = [
        {
          selector: "#main-view",
          content:
            "Welcome to GraphOwls, this is your graph where you can start with one data point and continue mining for more related information.",
        },
        {
    ...
    setIntroTour: (state) => {
      // TODO, introduce the main UI of graphowls on first startup
    },
